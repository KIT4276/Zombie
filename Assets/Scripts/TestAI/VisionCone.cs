...
namespace TopDownShooter
{
    public class VisionCone : MonoBehaviour
    {
        ...
        private float vision_angle;
        private float vision_range;
        private float vision_near_range;
        private LayerMask obstacle_mask;

        [Header("Vision"), SerializeField]
        private bool show_two_levels = false;

        [Space, Header("Material")]
        [SerializeField]
        private Material cone_material;
        [SerializeField]
        private Material cone_far_material;
        [SerializeField]
        private int sort_order = 1;

        [Space, Header("Optimization")]
        [SerializeField]
        ...
        private void Start()
        {
            vision_angle = target.GetAngle();
            vision_near_range = target.GetRadius();
            vision_range = vision_near_range / 2;
            obstacle_mask = target.ObstacleMask;
        ...
        private void Update()
        {
            ...
            transform.position = target.GetEye().transform.position;
